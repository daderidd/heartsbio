...
const chapters: Chapter[] = [
  {
    ...
    body: 'Decades of fertilizer application have loaded European soils with phosphorus. Yet 75–90% of applied P is rapidly fixed by metal-cation complexes in the soil — bound to iron, aluminium, and calcium — making it unavailable to crops.',
    stat: { value: '75–90%', label: 'of applied phosphorus is fixed in soil' },
  ...
  },
  {
    ...
    body: 'Since the 1960s, farmers have applied far more phosphorus than crops remove. The surplus accumulates as "legacy phosphorus" — residual P locked in soil that plants cannot access. Globally, an estimated 12,000 Tg has built up in cropland topsoils.',
  ...
  },
  {
    ...
    body: 'Phosphate rock is the only primary source of phosphorus fertilizer — and it is non-renewable. Over 70% of global reserves are concentrated in Morocco alone. Europe has near-zero domestic reserves and depends entirely on imports.',
  ...
  },
  {
    ...
    body: 'The EU Soil Monitoring Directive (2025) establishes soil health monitoring frameworks across member states. Phosphate rock has been on the EU Critical Raw Materials list since 2014. Fertilization limits are tightening — making efficient phosphorus use increasingly urgent.',
