...
const chapters: Chapter[] = [
  {
    ...
    body: 'Decades of fertilizer application have saturated European soils with phosphorus. But up to 80% of it is locked in forms plants cannot access — bound to iron, aluminium, and calcium minerals.',
    stat: { value: '80%', label: 'of soil phosphorus is unavailable to crops' },
  ...
  },
  {
    ...
    title: 'Billions of tons, buried in plain sight',
    body: 'European agricultural soils hold an estimated 2–4 billion tonnes of accumulated "legacy" phosphorus — residual P from decades of over-fertilization that remains chemically bound and biologically inert.',
    stat: { value: '2–4 Bt', label: 'of legacy phosphorus in European soils' },
    source: 'Alewell et al., Nature Geoscience (2020)',
  ...
  },
  {
    id: 'depletion',
    badge: 'RUNNING OUT',
    title: 'Meanwhile, the source is finite',
    body: 'Phosphate rock — the only primary source of phosphorus fertilizer — is a non-renewable resource concentrated in just a handful of countries. At current extraction rates, economically viable reserves may be exhausted within 50–100 years.',
    stat: { value: '50–100 yr', label: 'until economical phosphate rock depletion' },
  ...
  },
  {
    ...
    body: 'Phosphorus runoff is the primary driver of eutrophication — algal blooms that suffocate lakes, rivers, and coastal waters. The Baltic Sea, the Sea of Marmara, and freshwater bodies across Europe face severe ecological damage from agricultural phosphorus loss.',
    stat: { value: '#1', label: 'cause of freshwater quality degradation globally' },
    source: 'Carpenter, Annual Review of Environment and Resources (2008)',
  ...
  },
  {
    ...
    body: 'The EU Soil Monitoring Law (2025) introduces binding soil health targets. Phosphorus has been classified as a critical raw material. Countries are tightening fertilization limits — making efficient phosphorus use not just smart, but mandatory.',
    stat: { value: '2025', label: 'EU Soil Monitoring Law adopted' },
    source: 'European Council (September 2025)',
  ...
  },
  {
    ...
    body: 'HeartsBio\'s enzyme technology converts locked soil phosphorus into plant-available forms — turning a liability into an asset. Fitazim works in the field. Bio-Dop works at the factory. Together, they address the phosphorus problem from both ends of the value chain.',
